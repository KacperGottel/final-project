                        ...
                        <form:form metod="post" modelAttribute="user" class="user">
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <form:input path="username" type="text" class="form-control form-control-user" id="exampleFirstName"
                                                placeholder="Username"/>
                                    <form:errors path="username"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <form:input path="email" type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Email"/>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="password" name="repeatpassword" class="form-control form-control-user"
                                                id="PasswordRepeat" placeholder="Repeat password ${error}"/>
                                </div>
                            </div>
